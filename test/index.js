...
describe("API ENDPOINT TESTING", () => {
  ...
  it("POST Booking Page", (done) => {
    ...
    const dataSample = {
      ...
      firstName: "Lymanto",
      lastName: "Hadibrata",
      email: "lsdasd@gmail.com",
      phoneNumber: "12312312",
      accountHolder: "Lymanto",
      bankFrom: "BNI",
    };
    chai
      .request(app)
      ...
      .attach("image", fs.readFileSync(dataSample.image), "eth.png")
      .end((err, res) => {
        expect(err).to.be.null;
        expect(res).to.have.status(201);
        expect(res.body).to.be.an("object");
        expect(res.body).to.have.property("message");
        expect(res.body.message).to.have.to.equal("success booking");
